...
public class ListDatabase1 {
	...
	private class DBHelp extends SQLiteOpenHelper {
		...
		private final String TABLE_CREATE = "CREATE TABLE " + DB_TABLE1 + " ("
				+ D_ID + ", " + D_SOURCE + ", " + D_TYPE + ", " + D_SUBTYPE
				+ ", " + D_NUM + ", " + D_WORD + ", " + D_DEFINITION + ");";
		...
		private void loadWords() throws IOException {
			...
			InputStream inputStream = resources
					.openRawResource(R.raw.jingyue_jian);
		...
		public long addWord(String source, String type, String subtype,
				String num, String word, String definition) {
